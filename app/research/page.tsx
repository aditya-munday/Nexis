                ...
                <header className="relative overflow-hidden border border-border">
                  <div className="relative z-10 flex flex-col gap-6 p-5 md:gap-9 md:p-8 lg:min-h-[220px] lg:justify-center">
                    ...
                    <h1 className="max-w-4xl font-sans text-[28px] leading-[1.14] tracking-tight md:text-[38px] md:leading-[1.08]">
                      ...
                      <span className="text-white/45">for Safe Autonomous Computing.</span>
                    </h1>
                    <p className="max-w-2xl text-base leading-relaxed text-text-mute md:text-lg">
                      Directioner-OS Research develops the mathematical safety systems, capability boundaries, rollback proofs, and local intelligence that make autonomous computing dependable.
                    </p>
                  </div>
                </header>
                ...
                <section className="border-t border-border py-16 md:py-24 lg:py-28">
                  <div className="flex flex-col gap-5">
                    ...
                    <h2 className="max-w-3xl text-balance font-sans text-[26px] leading-[1.12] text-white sm:text-[30px] lg:text-[34px]">
                      Deterministic safety guarantees for non-deterministic intelligence.
                    </h2>
                  </div>
                  ...
                  <div className="mt-10 grid grid-cols-1 gap-px border border-border bg-border md:mt-14 md:grid-cols-2 lg:grid-cols-4">
                    <article className="flex min-h-56 flex-col gap-4 bg-surface p-6 transition-colors hover:bg-surface-hover md:p-7">
                      ...
                      <p className="text-sm leading-relaxed text-text-mute">
                        Every proposed system mutation runs through an isolated verification path before it reaches the capability daemon.
                      </p>
                    </article>
                    <article className="flex min-h-56 flex-col gap-4 bg-surface p-6 transition-colors hover:bg-surface-hover md:p-7">
                      ...
                      <p className="text-sm leading-relaxed text-text-mute">
                        Typed capabilities compile into immutable boundaries that cannot be bypassed by hallucinations or arbitrary shell execution.
                      </p>
                    </article>
                    <article className="flex min-h-56 flex-col gap-4 bg-surface p-6 transition-colors hover:bg-surface-hover md:p-7">
                      ...
                      <p className="text-sm leading-relaxed text-text-mute">
                        Hardware-backed controls and the physical killswitch enforce operator authority with cryptographic attestation.
                      </p>
                    </article>
                    <article className="flex min-h-56 flex-col gap-4 bg-surface p-6 transition-colors hover:bg-surface-hover md:p-7">
                      ...
                      <p className="text-sm leading-relaxed text-text-mute">
                        Action traces, dependency checks, rollback proofs, and state updates produce a tamper-evident Work Log.
                      </p>
                    </article>
                  </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 gap-px">
                      <div className="flex flex-col gap-4 bg-surface p-6 transition-colors hover:bg-surface-card md:flex-row md:items-center md:justify-between">
                        <div className="flex flex-col gap-1.5">
                          <span className="font-favorit text-xs uppercase tracking-4 text-white/40">DIR-TR-2026-01</span>
                          <h3 className="font-sans text-lg text-white">Capability-Scoped AI Engineers for Safe Autonomous Computing</h3>
                          <p className="text-sm text-text-mute">A framework for isolating model reasoning from privileged operating-system mutations.</p>
                        </div>
                      ...
                      <div className="flex flex-col gap-4 bg-surface p-6 transition-colors hover:bg-surface-card md:flex-row md:items-center md:justify-between">
                        <div className="flex flex-col gap-1.5">
                          <span className="font-favorit text-xs uppercase tracking-4 text-white/40">DIR-TR-2026-02</span>
                          <h3 className="font-sans text-lg text-white">Blast-Radius Verification for Autonomous System Mutations</h3>
                          <p className="text-sm text-text-mute">A deterministic evaluation framework for rollback completeness, invariant enforcement, and recovery behavior.</p>
                        </div>
                      ...
                      <div className="flex flex-col gap-4 bg-surface p-6 transition-colors hover:bg-surface-card md:flex-row md:items-center md:justify-between">
                        <div className="flex flex-col gap-1.5">
                          <span className="font-favorit text-xs uppercase tracking-4 text-white/40">DIR-TR-2026-03</span>
                          <h3 className="font-sans text-lg text-white">Capability RPC Specification: Typed Guardrails for System Workflows</h3>
                          <p className="text-sm text-text-mute">Formal specification of capability scopes, red-line invariants, and compensating rollback steps.</p>
                        </div>
